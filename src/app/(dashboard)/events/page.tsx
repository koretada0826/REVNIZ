    ...
    <div className="space-y-6 animate-in">
      <div className="flex flex-col lg:flex-row gap-6 items-start">
        <div className="flex-1">
          ...
          <p className="body-sm mt-1.5">オンラインの接点をリアルな交流や商談につなげる</p>
        </div>
        <div className="w-24 h-24 shrink-0 hidden lg:block opacity-50">
              ...
              <div className="flex flex-col sm:flex-row gap-5">
                <div className="shrink-0 sm:w-16">
                  <div className="bg-black-900 rounded p-3 text-center inline-block sm:block">
                    ...
                    <p className="text-[10px] text-black-300 tracking-wider uppercase mt-0.5">{ev.date.split("-")[1]}月</p>
                  </div>
                </div>
                <div className="flex-1 min-w-0">
                  ...
                  <h3 className="h3 text-[15px] mb-1.5">{ev.title}</h3>
                  ...
                  <div className="flex items-center gap-2.5">
                    <div className="flex-1 h-1 rounded-full bg-black-100 overflow-hidden">
                      <div className={`h-full rounded-full ${pct >= 90 ? "bg-red" : "bg-black-900"}`} style={{ width: `${pct}%` }} />
                    </div>
