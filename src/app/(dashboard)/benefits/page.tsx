    ...
    <FadeIn>
      <div className="space-y-8">
            ...
            >
              ...
              <span className="flex">
                ...
                >
                  ...
                  <span className="text-[16px] sm:text-[24px] font-black text-white leading-none px-1 sm:px-3 whitespace-nowrap block">
                    {plan.discount}
                  </span>
                  ...
                  <span
                    className="mt-1.5 sm:mt-3 px-2.5 sm:px-4 py-1 sm:py-1.5 rounded-full text-[10px] sm:text-[12px] font-bold bg-white text-[#C8102E] hover:bg-white/90 hover:scale-110 transition-all duration-200 inline-block animate-btn-pulse"
                  >
                    使う
                  </span>
                </span>
        ...
        >
          ...
          <button
            className="btn-primary px-8 py-3 animate-btn-pulse-red"
