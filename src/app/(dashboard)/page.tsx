...
import { ArrowRight, Building2, MessageSquare, Calendar, Handshake, TrendingUp, ChevronRight, ArrowUpRight, Zap, Clock } from "lucide-react";
    ...
    <div className="space-y-12">
      ...
      <section className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          <div key={s.label} className="card card-hover group cursor-pointer p-5">
            <s.icon className="w-5 h-5 text-black-300 mb-4" />
