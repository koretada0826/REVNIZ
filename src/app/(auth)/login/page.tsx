      ...
      <div className="hidden lg:flex lg:w-1/2 bg-black-900 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-14">
          <div className="flex items-center gap-2.5">
            <div className="w-9 h-9 rounded-md bg-black-800 border border-white/10 flex items-center justify-center">
              <span className="text-white font-bold text-[10px] tracking-[0.15em]">SC</span>
            </div>
            <div className="leading-none">
              <span className="font-bold text-[14px] text-white tracking-tight block">Sponsor Connect</span>
              <span className="text-[8px] text-white/30 tracking-[0.2em] uppercase">REVNIZE</span>
            </div>
          </div>

          <div className="max-w-lg">
            <div className="w-8 h-[3px] bg-red mb-8" />
            <h1 className="text-[2.8rem] font-bold text-white leading-[1.1] tracking-tight mb-6">
              スポンサーで<br />あることが、<br />
              <span className="text-red-400">次の取引</span>に<br />つながる。
            </h1>
            <p className="text-black-400 text-[15px] leading-relaxed max-w-sm">
          ...
          <div className="flex gap-10">
            {[
              { v: "24", l: "参加企業", icon: Users },
              { v: "48", l: "面談実績", icon: TrendingUp },
              { v: "92%", l: "継続率", icon: Shield },
            ].map((s) => (
              <div key={s.l}>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center bg-white px-6">
        <div className="w-full max-w-[380px]">
          <div className="lg:hidden flex items-center gap-2.5 mb-10">
            <div className="w-9 h-9 rounded-md bg-black-900 flex items-center justify-center">
              <span className="text-white font-bold text-[10px] tracking-[0.15em]">SC</span>
            </div>
          ...
          <form onSubmit={(e) => { e.preventDefault(); window.location.href = "/"; }} className="space-y-5">
            <div>
              ...
              <div className="relative">
                <Mail className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-black-300" />
            ...
            <div>
              ...
              <div className="relative">
                <Lock className="absolute left-3.5 top-1/2 -translate-y-1/2 w-4 h-4 text-black-300" />
            ...
            <div className="flex items-center justify-between">
              ...
              <Link href="#" className="text-[13px] text-red font-medium hover:text-red-700 transition-colors">パスワードを忘れた方</Link>
            </div>
            <button type="submit" className="btn-red w-full py-3.5">
