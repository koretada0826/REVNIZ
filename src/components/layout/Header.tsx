      ...
      <div className="max-w-7xl mx-auto px-5 lg:px-8">
        <div className="flex items-center justify-between h-[60px]">
              ...
              return (
                <Link key={item.href} href={item.href}
                  className={`relative flex items-center gap-1.5 px-3 py-1.5 rounded-full text-[13px] font-medium transition-all ${
                    active ? "text-black-900 bg-black-50" : "text-muted hover:text-black-900"
                  }`}>
          ...
          <div className="flex items-center gap-1">
            ...
            <Link href="/profile" className="hidden sm:flex items-center gap-2 rounded-full px-2.5 py-1.5 hover:bg-black-50 transition-colors">
              <div className="w-7 h-7 rounded-full bg-black-100 flex items-center justify-center">
              ...
              return (
                <Link key={item.href} href={item.href} onClick={() => setOpen(false)}
                  className={`flex items-center gap-3 rounded-md px-4 py-3 text-[13px] font-medium ${
                    active ? "text-black-900 bg-red-50" : "text-muted hover:text-black-900 hover:bg-black-50"
                  }`}>
